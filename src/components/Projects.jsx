...
import titleGenerator from "./../assets/title-generator.png";
import anniverSaya from "./../assets/anniversaya.png";
import party from "./../assets/christmas-party.png";
      ...
      <div className="background-light my-5 py-5">
        ...
        <div className="my-5">
          ...
          <div className="d-block d-md-flex gap-5 mt-5">
            <div className="p-5 col project-container mt-5 mt-md-0">
              <h4 className="dark fw-bold p-3 rounded-3 text-center">
                {userData.projects.project5.title}
              </h4>
              <div className="container">
                <a href={userData.projects.project5.link} className="">
                  <div className="project-img">
                    <img
                      src={titleGenerator}
                      alt="Research Title Generator"
                      className="w-75 d-block mx-auto pt-5"
                    />
                  </div>
                </a>
            ...
            <div className="p-5 col project-container mt-5 mt-md-0">
              <h4 className="dark fw-bold p-3 rounded-3 text-center">
                {userData.projects.project6.title}
              </h4>
              <div className="container">
                <a href={userData.projects.project6.link} className="">
                  <div className="project-img">
                    <img
                      src={anniverSaya}
                      alt="AnniverSaya Raffle Draw"
                      className="w-75 d-block mx-auto pt-5"
                    />
                  </div>
                </a>
          ...
          <div className="d-block d-md-flex gap-5 mt-5">
            <div className="p-5 col-12 col-md-6 project-container mt-5 mt-md-0">
              <h4 className="dark fw-bold p-3 rounded-3 text-center">
                {userData.projects.project7.title}
              </h4>
              <div className="container">
                <a href={userData.projects.project7.link} className="">
                  <div className="project-img">
                    <img
                      src={party}
                      alt="Raffle Game"
