      ...
      <div className="background-light my-5 py-5">
        ...
        <div className="container mt-5 py-5 d-block d-md-flex mx-auto gap-1">
          <div className="container">
            <h2 className="fw-bold text-secondary">2026</h2>
            <div className="rounded-3 shadow-sm p-3 bg-light">
              <h3 className="sub-title fw-bold">Software Developer</h3>
              <h5 className="text-secondary">Imperial Appliance Plaza</h5>
          ...
          <div className="container">
            ...
            <div className="rounded-3 shadow-sm p-3 bg-light">
              ...
              <h5 className="text-secondary">University of Iloilo</h5>
          ...
          <div className="container mt-3 mt-md-0">
            ...
            <div className="rounded-3 shadow-sm p-3 bg-light">
              ...
              <p>
                Built a personal repository exclusively for certain government
                in Iloilo. Designed the repo, and communicated closely with
        ...
        <div className="container-fluid py-3 py-md-5 d-md-flex flex-wrap mx-auto gap-4 align-items-center justify-content-center">
          {userData.certificates.map((certificate, index) => (
            ...
            >
              ...
              <small className="text-secondary">{certificate.issuedBy}</small>
              <a
